...
<h4><div id="Formulario1">Ingresar Datos del Reporte</div></h4>
...
<br>
<h5><div id="Formulario1">Fechas del reporte</div></h5>
...
<br>
<h5><div id="Formulario1">Corresponde a la</div></h5>
...
<center>
 ...
 input[type="text"]{
   ...
   margin: 0px auto;
	...
	<script src="assets/js/crear_inputs.js">
	</script>
	</html>
